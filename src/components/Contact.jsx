...
const EMAILJS_SERVICE_ID = 'service_wq3f8zj';
const EMAILJS_TEMPLATE_ID = 'template_345etlm';
const EMAILJS_PUBLIC_KEY = 'AFe69FwxGb9NdN5A0';

const SOCIALS = [
  {
    label: 'GitHub',
    href: 'https://github.com/PalaBhargav37',
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/pala-bhargav-52b498235/',
    icon: 'M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z M4 6a2 2 0 100-4 2 2 0 000 4z',
    color: '#00d4ff'
  },
  {
    label: 'LeetCode',
    href: 'https://leetcode.com/u/Bhargavpala/',
    icon: 'M10.786 5.866L5.152 11.5a.75.75 0 000 1.061l5.634 5.634a.75.75 0 101.06-1.06l-5.103-5.104 5.103-5.104a.75.75 0 00-1.06-1.06zM13.214 5.866a.75.75 0 011.06 0l5.634 5.634a.75.75 0 010 1.061l-5.634 5.634a.75.75 0 01-1.06-1.06l5.103-5.104-5.103-5.104a.75.75 0 010-1.061z',
    color: '#ffb347'
  },
  {
    label: 'Email',
    href: 'mailto:bhargavpala370@gmail.com',
...
export default function Contact() {
  ...
  const fields = [
    ...
    },
    {
      ...
      label: 'Email address',
      type: 'email',
      placeholder: 'bhargavpala370@gmail.com',
      icon: '✉️'
    },
    {
      name: 'subject',
      ...
      <div className="container" ref={ref}>
        <div className="reveal" style={{ textAlign: 'center' }}>
          ...
          <p className="contact-sub">
            I'm actively looking for new opportunities. Whether it's a role,
            a freelance project, or just a hello — my inbox is always open.
          </p>
        </div>
            ...
            <div className="form-card glass">
              ...
              {status === 'success' ? (
                <div className="success-state">
                  ...
                  <p>
                    Thanks for reaching out, {form.from_name || 'there'}.
                ...
                >
                    ...
                    {fields.map((f) => (
                      <div
                        ...
                        className={`field-group ${
                          ...
                          errors[f.name] ? 'has-error' : ''
                        } ${
                          focusedField === f.name ? 'focused' : ''
                        }`}
                      >
                  ...
                  <div className="form-footer">
                    ...
                    <p className="form-note">
                      <span>🔒</span>
                      Your privacy matters. The information you submit
                      through this form is used only for communication
                      purposes.
                    </p>
